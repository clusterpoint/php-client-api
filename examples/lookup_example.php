...
try {
  ...
  $lookupRequest = new cps\CPS_LookupRequest('id1', array('document' => 'no', 'name' => 'yes'));
  ...
  $lookupRequest = new cps\CPS_LookupRequest(array('id2', 'id3'), array('document' => 'no', 'name' => 'yes'));
  $lookupResponse = $cpsConnection->sendRequest($lookupRequest);
  foreach ($lookupResponse->getDocuments() as $id => $document) {
    echo $document->name . '<br />';
  }
